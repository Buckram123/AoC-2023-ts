...
// after that check:
// [0, -1](if no "symbol" on [0, 1])
// [0, 1], [1, 0] and [1, 1] (if no "symbol" on [0, 1] or [1, 0]) positions
// with saving those numbers. Or something like this, need more testing on this one
